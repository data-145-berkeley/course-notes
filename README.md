...
1. Create a local copy of this repo by running `git clone https://github.com/data-145-berkeley/course-notes.git` from the command line in whichever folder you want to contain the textbook.
...
1. **Pull:** `cd` into `notes/`, your local copy of the repository and `git pull origin main` to collect any updates which may have been pushed to the remote copy by other collaborators.
